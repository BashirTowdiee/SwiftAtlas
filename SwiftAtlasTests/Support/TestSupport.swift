...
final class TestCacheStore: CacheStore, @unchecked Sendable {
  ...
  func value<Value>(for key: CacheKey, as type: Value.Type) throws -> Value?
  ...
  static func diagnosticsSnapshot(
    ...
    DiagnosticsSnapshot(
      metadata: BuildMetadata(
        bundleIdentifier: "org.example.SwiftAtlasTests", shortVersion: "1.0", buildNumber: "1"),
  ...
  static func makeContainer(
    ...
    return AppContainer(
      ...
      diagnosticsService: diagnosticsService
        ?? DiagnosticsService(cacheLocation: "/tmp/tests", featureFlagStore: featureFlagStore)
    )
  }
}
