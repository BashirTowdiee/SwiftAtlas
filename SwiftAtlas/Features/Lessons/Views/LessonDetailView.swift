        ...
        VStack(alignment: .leading, spacing: GSSpacing.large) {
          ...
          GSCard {
            VStack(alignment: .leading, spacing: GSSpacing.small) {
              GSSectionHeader(
                eyebrow: "Teaching Points", title: "Why this lesson matters", detail: nil)
          ...
          GSCard {
            VStack(alignment: .leading, spacing: GSSpacing.small) {
              GSSectionHeader(
                eyebrow: "Discussion", title: "Mapped comments",
                detail: "These are JSONPlaceholder comments mapped into lesson discussion.")
