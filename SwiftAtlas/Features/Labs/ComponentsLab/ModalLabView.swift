    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: GSSpacing.medium) {
                GSCard {
                    VStack(alignment: .leading, spacing: GSSpacing.medium) {
                        GSSectionHeader(eyebrow: "Modals", title: "Presentation rules", detail: "Choose the smallest presentation mechanism that matches the task.")
                        GSPrimaryButton(title: "Show Sheet", systemImage: "rectangle.portrait.bottomhalf.inset.filled") {
