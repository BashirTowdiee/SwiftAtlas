            ...
            VStack(alignment: .leading, spacing: GSSpacing.large) {
                GSCard {
                    VStack(alignment: .leading, spacing: GSSpacing.medium) {
                        GSSectionHeader(eyebrow: "Structured Concurrency", title: "Actors, task groups, and cancellation", detail: "The view model is main-actor isolated and the counter is actor-isolated.")
