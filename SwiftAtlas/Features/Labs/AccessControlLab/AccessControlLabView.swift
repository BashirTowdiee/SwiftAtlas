            ...
            VStack(alignment: .leading, spacing: GSSpacing.medium) {
                GSCard {
                    VStack(alignment: .leading, spacing: GSSpacing.small) {
                        GSSectionHeader(eyebrow: "Access Control", title: "Visibility and special identifiers", detail: "The examples here are backed by real Swift declarations, not text-only notes.")
