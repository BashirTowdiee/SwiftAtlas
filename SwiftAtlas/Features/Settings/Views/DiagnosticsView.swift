    ...
    var body: some View {
        GSCard {
            VStack(alignment: .leading, spacing: GSSpacing.medium) {
                GSSectionHeader(eyebrow: "Diagnostics", title: "Build and runtime metadata", detail: "Diagnostics should be readable from the app shell without digging through implementation details.")
                if let snapshot {
